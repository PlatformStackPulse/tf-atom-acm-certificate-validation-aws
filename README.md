...
[![CI](https://github.com/PlatformStackPulse/tf-atom-acm-certificate-validation-aws/actions/workflows/ci.yml/badge.svg)](https://github.com/PlatformStackPulse/tf-atom-acm-certificate-validation-aws/actions/workflows/ci.yml)
[![Latest Release](https://img.shields.io/github/v/release/PlatformStackPulse/tf-atom-acm-certificate-validation-aws)](https://github.com/PlatformStackPulse/tf-atom-acm-certificate-validation-aws/releases)
...
Terraform atom: AWS ACM Certificate Validation - waits for certificate DNS validation to complete
...
| <a name="input_validation_record_fqdns"></a> [validation\_record\_fqdns](#input\_validation\_record\_fqdns) | List of FQDNs of the DNS validation records | `list(string)` | `null` | no |
